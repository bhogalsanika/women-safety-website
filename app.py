...
<style>
    ...
    /* Header */
    .hero {
        background: linear-gradient(135deg, #fff0f6, #f3f6ff);
        padding: 28px;
        border-radius: 18px;
...
with st.sidebar:
    ...
    st.markdown("""
    <div class="logo-box">
        <div class="logo-title">🌸 Digital Saheli</div>
...
<div class="hero">
    ...
    <p>
        ...
        practice through quizzes and get help when needed.
    </p>
</div>
""", unsafe_allow_html=True)
...
if page == "🏠 Dashboard":
    ...
    st.markdown(
        '<div class="section-subtitle">Overview of community participation and digital safety activities.</div>',
        unsafe_allow_html=True
    )
    ...
    with q1:
        ...
        <div class="info-card">
            ...
            <p>
                Learn practical smartphone tasks such as
                making calls, using WhatsApp and digital payments.
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with q2:
        ...
        <div class="info-card">
            ...
            <p>
                Learn how to protect passwords, OTPs,
                UPI payments, social media and privacy.
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with q3:
        ...
        <div class="info-card">
            ...
            <p>
                Take an interactive safety quiz and
                save your result in the database.
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    if len(safety_df) > 0:
        ...
        if "event_type" in safety_df.columns:
            ...
            event_count = safety_df["event_type"].value_counts().reset_index()
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-subtitle">Register and manage women participating in the programme.</div>',
        unsafe_allow_html=True
    )

    with st.expander("➕ Add New Participant", expanded=True):
        ...
        with st.form("participant_form"):
            ...
            if submitted:
                ...
                if name.strip() == "":
                    ...
                    if add_record("participants", data):
    ...
    if len(participants_df) > 0:
        ...
        participant_options = {
            f"{row.get('name', 'Unknown')} — ID {row.get('participant_id')}":
        ...
        if participant_options:
            ...
            if st.button("Delete Selected Participant"):
                ...
                pid = participant_options[selected_delete]
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-subtitle">Record how participants use smartphones for daily activities.</div>',
        unsafe_allow_html=True
    )
        ...
        with st.form("smartphone_usage_form"):
            ...
            if submitted:
                ...
                data = {
                    ...
                    "social_media": social_media == "Yes",
                    "digital_payment": digital_payment == "Yes",
                    "online_shopping": online_shopping == "Yes",
                    "education": education == "Yes",
                    "daily_usage_hours": daily_hours
                }

                if add_record("smartphone_usage", data):
                    st.success("Smartphone usage record saved.")
                    st.rerun()
    ...
    if len(smartphone_df) > 0:
        ...
        st.info("No smartphone usage records yet.")
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-title">📚 Learn Smartphone</div>',
        unsafe_allow_html=True
    )

    st.markdown(
        '<div class="section-subtitle">Choose one topic and learn it step-by-step.</div>',
        unsafe_allow_html=True
    )
    ...
    smartphone_topics = {
        ...
        "💳 Use UPI Payment": {
            "title": "How to Make a UPI Payment",
            "steps": [
        ...
        "📍 Share Location": {
            "title": "How to Share Your Location",
            "steps": [
    ...
    topic = smartphone_topics[selected_topic]
    ...
    st.success(
        "💡 Tip: Practice one smartphone task at a time until you feel comfortable."
    )
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-subtitle">Select a safety topic to learn practical protection steps.</div>',
        unsafe_allow_html=True
    )
    ...
    safety_topics = {
        ...
        "🔐 Password Safety": {
            "title": "How to Keep Your Password Safe",
            "steps": [
        ...
        "🔢 OTP Scam": {
            "title": "How to Stay Safe from OTP Scams",
            "steps": [
        ...
        "🔗 Suspicious Links": {
            "title": "How to Identify Suspicious Links",
            "steps": [
        ...
        "👤 Fake Social Media Account": {
            "title": "What to Do About a Fake Account",
            "steps": [
        ...
        "📍 Location Privacy": {
            "title": "How to Protect Location Privacy",
            "steps": [
    ...
    topic = safety_topics[selected_safety]

    st.markdown(
        f"""
        <div class="learning-box">
            <h3>{topic["title"]}</h3>
            <p>Follow these safety steps:</p>
        """,
        unsafe_allow_html=True
    )
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-subtitle">Answer one question at a time and test your online safety knowledge.</div>',
        unsafe_allow_html=True
    )

    if len(participants) == 0:

        st.warning("Please add at least one participant before starting the quiz.")
        ...
        if not st.session_state.quiz_started:
            ...
            <div class="info-card">
                ...
                <p>• There are 8 questions.</p>
                <p>• One question will appear at a time.</p>
                <p>• Select one answer and click Next.</p>
                <p>• Your final score will be stored in the database.</p>
            </div>
            """, unsafe_allow_html=True)
            ...
            if st.button(
                ...
                st.session_state.quiz_participant_id = participant_options[selected]
        ...
        # ----------------------------------------------------
            ...
            st.markdown(
                ...
                <div class="quiz-question">
                    <div class="quiz-number">
                        QUESTION {current + 1} OF {len(quiz_questions)}
                    </div>
                    <div class="quiz-text">
                        {question["question"]}
                    </div>
            ...
            previous_answer = st.session_state.quiz_answers.get(current)
            ...
            with col1:
                ...
                if current > 0:
                    ...
                    if st.button(
                        ...
                        st.session_state.quiz_answers[current] = selected_answer
                ...
                if current < len(quiz_questions) - 1:
                    ...
                    if st.button(
                        ...
                        if selected_answer is None:
                            ...
                            if add_record("quiz_results", data):
        ...
        # ----------------------------------------------------
            ...
            st.markdown(
                f"""
                <div class="learning-box" style="text-align:center;">
                    <h3>🎉 Quiz Completed!</h3>
                    <div style="font-size:42px;font-weight:800;color:#b23a6f;">
                        {score}/{total}
                    </div>
                    <p style="font-size:18px;">
                        Your Score: <b>{percentage:.0f}%</b>
                    </p>
                </div>
                """,
                unsafe_allow_html=True
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-subtitle">Record and monitor online safety incidents reported by participants.</div>',
        unsafe_allow_html=True
    )
    ...
    if len(participants) == 0:
        ...
        with st.form("safety_event_form"):
            ...
            if submitted:
                ...
                if add_record("safety_events", data):

                    st.success("Safety event recorded successfully.")
                    st.rerun()
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-subtitle">Important emergency and cyber safety contacts.</div>',
        unsafe_allow_html=True
    )
    ...
    with c1:
        ...
        <div class="emergency-card">
            ...
            <p>National emergency number for immediate assistance.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with c2:
        ...
        <div class="emergency-card">
            ...
            <div class="emergency-number">181</div>
            <p>Women helpline for support and assistance.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with c3:
        ...
        <div class="emergency-card">
            ...
            <p>Cyber crime helpline for online financial/cyber fraud.</p>
        </div>
        """, unsafe_allow_html=True)

    st.markdown("### What should you do during an online fraud?")

    steps = [
        "Stay calm and do not share additional OTPs, passwords or PINs.",
        "Contact your bank/service provider through its official channel.",
    ...
    st.warning(
        "Never share your OTP, UPI PIN, password or banking credentials with anyone."
    )
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-subtitle">Record digital literacy and online safety training activities.</div>',
        unsafe_allow_html=True
    )
    ...
    with st.form("training_form"):
        ...
        if submitted:
            ...
            if add_record("training_sessions", data):
...
# ============================================================
    ...
    st.markdown(
        '<div class="section-subtitle">Analyse participant activity, safety awareness and quiz performance.</div>',
        unsafe_allow_html=True
    )
    ...
    if len(smartphone_df) > 0 and "usage_purpose" in smartphone_df.columns:
    ...
    if len(quiz_df) > 0:
        ...
        st.info("No quiz attempts available yet.")
...
st.markdown(
    ...
    <div style="text-align:center;color:#888;font-size:13px;padding:10px;">
        🌸 <b>Digital Saheli</b> |
        Smartphone Usage & Online Safety for Women Self Help Groups<br>
